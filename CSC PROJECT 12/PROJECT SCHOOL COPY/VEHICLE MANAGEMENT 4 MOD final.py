...
def cars():
    def incars():
        ...
        if a == 9:
            bb='Mercedes Benz'
            print('[1]Mercedes Benz EQS')
            print('[2]Mercedes Benz G-CLASS')
            print('[3]Mercedes Benz C-CLASS')
            print('[4]Mercedes Benz GLA')
            print('[5]Mercedes Benz MAYBACH S-CLASS')
            print('[6]Mercedes Benz A CLASS LIMOUSINE')
            print('[7]Mercedes Benz GLS')
            print('[8]Mercedes Benz E-CLASS')
            print('[9]Mercedes Benz MAYBACH GLS')
            ...
            if user in a and mail in b:
                ...
                if detail=='1':
                    ...
                    while True:
                        ...
                        doorno=input('Enter your doorno:')
                        ed=[]
                        with open('car_booking.csv','a+') as F:
                            re=csv.reader(F)
                            wr=csv.writer(F)
                            for i in re:
                                if len(i)>5:
                            ...
                            for j in range(len(ed)):
                                for k in len(j):
                                    if ed[j][0]==user:
                                        ...
                                        continue
                        with open('car_booing.csv','w',newline='\n')as GG:
                            wr=csv.writer(GG)
                            wr.writerows(ep)
                print('Success')
                    ...
                    if hh=='1':
                        ...
                        with open('car_booking.csv','r') as J:
                            ...
                            for k in range(len(df)):
                                if df[k][0]== name:
                                    dat=df[k][-1]
                                    datx=datetime.datetime.strptime(dat, '%Y-%m-%d').date()
                                    remdays=datx-tday
                                    remdays=str(remdays)
